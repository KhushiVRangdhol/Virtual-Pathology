...
for k in range(0,n1):
    ...
    ssim_patch = ssim(gt_patch, predict_patch, data_range=predict_patch.max() - predict_patch.min(), multichannel=True)
  
    print('\nImage Pair', k+1, ' ',predict_image[k],' vs ',original_HE_image[k],' SSIM =',ssim_patch)
